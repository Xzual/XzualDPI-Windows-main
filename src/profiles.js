...
// ─── BYPASS PROFILES (APPS) ─────────────────────────────────────
// Belirli servisleri tek tıkla bypass listesine eklemek için.
// ─────────────────────────────────────────────────────────────────
export const BYPASS_PROFILES = [
  { id: 'discord', name: 'Discord', domains: 'discord.com,discordapp.com,discord.gg,discord.media,discordapp.net' },
  { id: 'youtube', name: 'YouTube', domains: 'youtube.com,googlevideo.com,ytimg.com,ggpht.com' },
  { id: 'instagram', name: 'Instagram', domains: 'instagram.com,cdninstagram.com' },
  { id: 'twitter', name: 'Twitter (X)', domains: 'twitter.com,t.co,twimg.com,x.com' },
  { id: 'twitch', name: 'Twitch', domains: 'twitch.tv,ttvnw.net' },
];
