const translations = {
  tr: {
    ...
    modalPacWarningDesc: 'Xzual kapatıldıktan sonra YouTube vb. uygulamalarda internet sorunu yaşarsanız (eski önbellek nedeniyle), Wi-Fi bağlantısını kapatıp açmanız yeterlidir.',
    modalManualWarningTitle: 'DİKKAT:',
    modalManualWarningDesc: 'Xzual kapatıldığında internet bağlantısı tamamen kesilir. İnternete tekrar girmek için cihazınızın Wi-Fi ayarlarından Proxy\'i eski haline (Yok) getirmelisiniz.',
    ...
    adminDesc: 'XzualDPI\'ın düzgün çalışması için yönetici olarak çalıştırılması gereklidir.',
    ...
    logEngineStarting: (port) => `Xzual Motoru başlatılıyor (Port: ${port})...`,
    ...
    logEngineStopped: (code) => `Xzual motoru beklenmedik şekilde durduruldu (Kod: ${code})`,
    ...
    logReasonFirewall: 'Firewall/Antivirüs XzualDPI\'ı engelliyor olabilir',
    ...
    logEngineStoppedGrace: 'Xzual motoru kapatıldı.',
    ...
    logEngineActive: '✓ Xzual motoru aktif',
    ...
    logInternetCheck: 'İnternet bağlantısı kontrol ediliyor...',
    ...
    logAntivirusWarning: 'Windows Defender veya antivirüs yazılımınız \'xzual-proxy.exe\' dosyasını engellemiş olabilir. Lütfen dosyayı antivirüs dışlama listesine (exclusion) ekleyin.',
    ...
    autoStartDesc: 'Windows açılınca XzualDPI\'ı başlat',
    ...
    devRole: 'XzualDPI Geliştiricisi',
    ...
    noticeDesc: 'Xzual motoru, Windows Defender AI gibi yapay zeka tabanlı sistemler tarafından bazen "yanlış pozitif" olarak algılanabilir. Bu durum tamamen zararsızdır. Ayrıca Kaspersky, ESET gibi yazılımlar HTTPS tarama özelliğiyle bağlantıyı engelleyebilir. Erişim sorunu yaşarsanız bu ayarları kontrol edin.',

    // Dialogs
    confirmExitTitle: 'Çıkış',
    confirmExitDesc: 'Xzual motorunu durdurup çıkmak istediğinize emin misiniz?',
    ...
    // Themes
    themeTitle: 'GÖRÜNÜM TEMASI',
    themeDesc: 'Uygulamanın ana renk paletini değiştirin',
    themeBlue: 'Okyanus Mavisi',
    themeEmerald: 'Zümrüt Yeşili',
    themeAmber: 'Kehribar Sarısı',
    themeRose: 'Gül Kırmızısı',
    themePurple: 'Galaksi Moru',

    // Speed Test
    speedTestTitle: 'HIZ VE LATANS TESTİ',
    speedTestDesc: 'Mevcut bypass bağlantınızın kalitesini ölçün',
    btnRunSpeedTest: 'Testi Başlat',
    speedTestRunning: 'Ölçülüyor...',
    speedTestResultPing: 'Gecikme (Ping)',
    speedTestResultSpeed: 'İndirme Hızı',

    // Filtering
    sectionFiltering: 'AĞ FİLTRELEME (GELİŞMİŞ)',
    filteringDesc: 'Hangi sitelerin bypass edileceğini PAC modunda seçin',
    whitelistTitle: 'Bypass Edilecek Siteler (Beyaz Liste)',
    blacklistTitle: 'Bypass Edilmeyecek Siteler (Kara Liste)',
    filteringPlaceholder: 'örneğin: youtube.com (her satıra bir tane)',
    filteringEnable: 'PAC Filtreleme Modunu Aktif Et',
    filteringEnableDesc: 'Daha esnek kontrol için AutoConfigURL kullanır',
  },
  ...
  en: {
    ...
    modalPacWarningDesc: 'If apps like YouTube lose internet access after closing Xzual (due to cached connections), simply toggle your device\'s Wi-Fi off and on.',
    modalManualWarningTitle: 'ATTENTION:',
    modalManualWarningDesc: 'When Xzual is closed, your device will completely lose internet access. To restore connection, you must remove the Proxy setting from your Wi-Fi settings.',
    ...
    adminDesc: 'XzualDPI needs to run as administrator to work correctly.',
    ...
    // ===== APP.JSX - Log Messages =====
    logEngineStarting: (port) => `Xzual Engine starting (Port: ${port})...`,
    ...
    logEngineStopped: (code) => `Xzual engine stopped unexpectedly (Code: ${code})`,
    ...
    logReasonFirewall: 'Firewall/Antivirus may be blocking Xzual',
    ...
    logEngineStoppedGrace: 'Xzual engine stopped.',
    ...
    logEngineActive: '✓ Xzual engine active',
    ...
    logInternetCheck: 'Checking internet connection...',
    ...
    logAntivirusWarning: 'Windows Defender or your antivirus software may have blocked \'xzual-proxy.exe\'. Please add the file to your antivirus exclusion list.',
    ...
    autoStartDesc: 'Launch Xzual when Windows starts',
    ...
    noticeDesc: 'The Xzual engine may sometimes be flagged as a "false positive" by AI-based systems like Windows Defender. This is completely harmless. Also, antivirus software like Kaspersky or ESET may block connections with their HTTPS scanning. If you experience issues, check those settings.',

    // Dialogs
    confirmExitTitle: 'Exit',
    confirmExitDesc: 'Are you sure you want to stop the Xzual engine and exit?',
    ...
    themeDesc: 'Change the primary color palette of the app',
    themeBlue: 'Ocean Blue',
    themeEmerald: 'Emerald Green',
    themeAmber: 'Amber Yellow',
    themeRose: 'Rose Red',
    themePurple: 'Galaxy Purple',

    // Speed Test
    speedTestTitle: 'SPEED & LATENCY TEST',
    speedTestDesc: 'Measure the quality of your bypass connection',
    btnRunSpeedTest: 'Run Test',
    speedTestRunning: 'Testing...',
    speedTestResultPing: 'Latency (Ping)',
    speedTestResultSpeed: 'Download Speed',

    // Filtering
    sectionFiltering: 'NETWORK FILTERING (ADVANCED)',
    filteringDesc: 'Choose which sites to bypass in PAC mode',
    whitelistTitle: 'Sites to Bypass (Whitelist)',
    blacklistTitle: 'Sites to Skip (Blacklist)',
    filteringPlaceholder: 'example: youtube.com (one per line)',
    filteringEnable: 'Enable PAC Filtering Mode',
    filteringEnableDesc: 'Uses AutoConfigURL for flexible control',
  }
};
